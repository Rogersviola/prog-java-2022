...
private static final String DB_DATEBASE = "prog_java_2022";
...
private ConexaoBD() {
	...
	strConn = "jdbc:"+ DB_DRIVER+"://"+DB_HOST+":"+DB_PORT+"/"+DB_DATEBASE;
		dbUser = DB_USER;
		dbPass = DB_PASS;
...
public void conectarBD() throws SQLException {
	conector = null;
	conector = DriverManager.getConnection(getStrConn(),getDbUser(),getDbPass());
}
