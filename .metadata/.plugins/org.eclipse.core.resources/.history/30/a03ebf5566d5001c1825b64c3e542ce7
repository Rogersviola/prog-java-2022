...
public class Aula16Exe02 {
	...
	private static int consultaCliente(Clientes[] cliVetor, Scanner sc) {
		...
		intCod = sc.nextInt();
			...
			if (cliVetor[intI]!=null && cliVetor[intI].getCodigo()==intCod) {
				...
				System.out.print("Código...:" + cliVetor[intI].getCodigo());
				System.out.print("Nome......:"+ cliVetor[intI].getNome());
				System.out.println("Endereço.:" + cliVetor[intI].getEndereco());
				break;
			}
		}
		return intRet;
	...
	/**
	 * Função que retorna o índice disponivel para ser cadastrado o cliente. Se não houver disponível retornará-1.
	 * @param cliVetor Informar o vetor de clientes.
	 * @return Retorna o ídice disponível ou -1 se não houver mais espaço para cadastramento.
	 */
